...
import com.bhuvan_kumar.Presto.adapter.NetworkDeviceListAdapter;
        ...
        implements TitleSupport, UITask, IconSupport, ConnectionManagerActivity.DeviceSelectionSupport
{
    ...
    {
        View view = inflater.inflate(R.layout.fragment_barcode_permissions, container, false);
        ...
        cameraPermission = view.findViewById(R.id.camera_permission);

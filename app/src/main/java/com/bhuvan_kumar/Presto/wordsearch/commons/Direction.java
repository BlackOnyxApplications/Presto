package com.bhuvan_kumar.Presto.wordsearch.commons;
...
public enum Direction {
    ...
    public static Direction fromLine(com.bhuvan_kumar.Presto.wordsearch.commons.GridIndex start, com.bhuvan_kumar.Presto.wordsearch.commons.GridIndex end) {

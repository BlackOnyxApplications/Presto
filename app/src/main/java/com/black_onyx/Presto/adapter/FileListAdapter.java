package com.black_onyx.Presto.adapter;
...
import androidx.annotation.NonNull;
 import androidx.annotation.Nullable;import com.black_onyx.Presto.GlideApp;
...
import com.black_onyx.Presto.util.MimeIconUtils;
        ...
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<FileListAdapter.GenericFileHolder>
{
    ...
    protected void onLoad(GroupLister<GenericFileHolder> lister)
    {
        ...
        if (path != null) {
            ...
            lister.offerObliged(this, new DirectoryHolder(defaultFolder, getContext().getString(R.string.text_receivedFiles), R.drawable.presto_p_white_png));

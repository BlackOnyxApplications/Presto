package com.black_onyx.Presto.wordsearch.commons;
...
public enum Direction {
    ...
    public static Direction fromLine(com.black_onyx.Presto.wordsearch.commons.GridIndex start, com.black_onyx.Presto.wordsearch.commons.GridIndex end) {
